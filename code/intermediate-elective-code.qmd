...
vp_plot <- ggplot(summary_all) +
  ...
  labs(
    ...
    subtitle = paste("\nThis visualization shows the cumulative percent cover",
                 ...
                 sep = "\n"),
    caption  = "\nSource: CCBER | Visualization: Macey Hartmann | Template: Tobias Stalder · github.com/toebR/Tidy-Tuesday",
...
as previous visualizations used straightforward x and y axes, while this figure uses `coord_polar()` to 
